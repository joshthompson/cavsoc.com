...
<body>
	...
	<header>
		<h1 id="logo" class="cavsoc-heading" onclick="gotoPage('')"><em>CAV</em>SOC</h1>
	...
	<div data-page="" class="active">
		<div id="background" title="Click on the image to view the video"></div>
		<div id="nav-left" class="link"><img src="./images/ui/left.png" alt="View Previous" /></div>
		<div id="nav-right" class="link"><img src="./images/ui/right.png" alt="View Next" /></div>
	</div>

	<div data-page="work" class="content-page">
		<div class="page-content">
			<h2 class="cavsoc-heading"><em class="our">Our</em>Work</h2>

			<div class="work">
				<div class="work-tile" onclick="gotoPage('work/wsstudio')">
	...
	<div data-page="work/wsstudio" class="content-page">
		<div class="page-content">
			<h2 class="cavsoc-heading"><em>WS</em>Studio</h2>
			<div class="project">
				<img class="project-image-main" src="./images/work/wsstudio/ws-1-main.jpg" />

				<h3>W.S. Studio (<a href="https://www.wssfashion.com/" target="_blank">https://www.wssfashion.com/</a>)</h3>
				<p>Look Book - Print &amp; Online Photography</p>

				<div class="project-section">
					<img class="project-image" src="./images/work/wsstudio/ws-2-simplicity.jpg" />
					<h4>Simplicity</h4>
					<p>W.S. Studio asked us to photograph their first ever range, the 2015 Spring/Summer Womenswear Collection. Looking for a simple studio style, they favoured shots that would serve well as both a basic look book and as product images for their website and their various stockists.</p>
				</div>
				...
				<div class="project-section">
					...
					<p>Despite the tight schedule, we requested a couple of extra minutes with the models per look, before they got changed and the next outfit was prepared. We wanted time to experiment with looser, more varied poses, and recognised how valuable these shots would be for wider marketing purposes. We captured some of our best shots in this “borrowed time”, which went on to become the key images used throughout the campaign.</p>
				</div>

				<div class="project-section">
					<img class="project-image" src="./images/work/wsstudio/ws-5-an-ongoing-collaboration.jpg" />
					<h4>An ongoing collaboration</h4>
					<p>Since photographing their first collection, we have gone on to form a strong working relationship with W.S. Studio, photographing their second collection’s look book and editorial (feature picture), papping influencers wearing their garments at London Fashion Week, and collaborating with them to feature their designs in our music videos for Sabrina Gunston (<a href="https://vimeo.com/149508305" target="_blank">https://vimeo.com/149508305</a>) and Tops &amp; Nina (<a href="https://vimeo.com/150074109" target="_blank">https://vimeo.com/150074109</a>).</p>
				</div>
				...
				<div class="project-section">
					<p>Models: Jessica Cleary (<a href="https://www.instagram.com/jesscleary_/" target="_blank">https://www.instagram.com/jesscleary_/</a>) &amp; Annabelle Strutt (<a href="https://www.starnow.com/annabellestrutt1" target="_blank">https://www.starnow.com/annabellestrutt1</a>) for Profile Models (<a href="https://www.profile-models.com/" target="_blank">https://www.profile-models.com/</a>)</p>

					<p>Photographer: Joseph Madden (<a href="http://josephmadden.co.uk/" target="_blank">http://josephmadden.co.uk/</a>)</p>
					<p>Assistant: Patrick Larder (<a href="https://www.patricklarder.com/" target="_blank">https://www.patricklarder.com/</a>)</p>
				</div>
			</div>
		</div>
	</div>

	<div data-page="story" class="content-page">
		<div class="page-content">
			...
			<p>At its heart, though, CAVSOC is a collective of friends who love working together and are passionate about what they do. And we mean real friends, this isn’t the usual corporate spiel of feeling like a family. We grew up and learnt together. We work, play and laugh together, and understand each other, something we’ve always found has given us the edge in an industry that is based on collaborative efforts.</p>
			<p>Having worked client-side, agency-side and freelance, we teamed up to share our expertise and create work we could be proud of on our own terms. We’ve worked for some of the world’s leading brands, blah blah blah…</p>

		</div>
	</div>

	<div data-page="team" class="content-page">
		<div class="page-content">
			...
			<div class="team-member" id="joe">
				...
				<div class="info">
					...
					<hr />
					<div class="role">Director • Photographer</div>
					<p>Joe is a highly successful con artist, having been masquerading as a director and photographer for the past six years without anyone finding out that he doesn't know what he's doing. Joe learnt his trade on the job as an in-house videographer and subsequently freelanced as a camera operator and editor for a string of ad agencies and production companies before setting up <em>CAV</em>SOC.</p>
					<p>Joe has travelled the world directing commericials, corporate content and music videos and now oversees production on dozens of projects of all sizes.</p>
					<div class="email">joe@cavsoc.com</div>
				</div>
			</div>
	...
	<footer>
		...
		<nav>
			<a onclick="gotoPage('work')">//<em>Our</em>Work</a>
			<a onclick="gotoPage('story')">//<em>Our</em>Story</a>
			<a onclick="gotoPage('team')">//<em>Our</em>Team</a>
	...
	<div id="burger-menu">
		<div class="menu">
			<a onclick="gotoPage('')"><h3><em>CAV</em>SOC</h3></a>
			<div><a class="nav-link" onclick="gotoPage('work')">//<em>Our</em>Work</a></div>
			<div><a class="nav-link" onclick="gotoPage('story')">//<em>Our</em>Story</a></div>
			<div><a class="nav-link" onclick="gotoPage('team')">//<em>Our</em>Team</a></div>
	...
	<script type="text/javascript" src="./main.js?v=0.19"></script>
</body>
</html>